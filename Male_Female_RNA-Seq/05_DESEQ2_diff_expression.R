...
setwd("~/Dropbox/Leicester_postdoc/Projects/lice/RNA_male_female/gene_results")
library(DESeq2)
library(ggplot2)
library(ggrepel)
...
sample <- c("Female1","Female2","Female3","Male1","Male2","Male3")
...
# This doesn't work with artifical replicates, it suggests the below
...
#------------------------------------------------------------------
# PCA plot
data = plotPCA(dds, intgroup = c("ecotype"), returnData=TRUE)
...
rownames(sampleDistMatrix) <- paste( dds$dex, dds$cell, sep = " - " )
